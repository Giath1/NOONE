------------------------------------------------
-- This Source Was Developed By (BlackPink) @KKKZB.--
--   This Is The Source Channel @KKKZB .   --
--                - 𝐌𝐎𝐒𝐂𝐎𝐖-                 --
--        -- https://t.me/KKKZB --         --
------------------------------------------------ 
...
return {
Lock     = '[𝐌𝐎𝐒𝐂𝐎𝐖](https://t.me/NNNZO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[𝐌𝐎𝐒𝐂𝐎𝐖](https://t.me/NNNZO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝐌𝐎𝐒𝐂𝐎𝐖](https://t.me/NNNZO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[𝐍𝐈𝐆𝐇𝐓𝐌𝐀??𝐄](https://t.me/NNNZO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[𝐌𝐎𝐒𝐂𝐎𝐖](https://t.me/NNNZO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[𝐌𝐎𝐒𝐂𝐎𝐖](https://t.me/NNNZO)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = '𝐌𝐎𝐒𝐂𝐎𝐖 ⁦', url='https://t.me/NNNZO'},
},
}
}
...
download('https://raw.githubusercontent.com/Mohmmedrg/SXEYSCOR/main/BlackPink.lua','BlackPink.lua')
...
{{text =news,url = "https://t.me/NNNZO"}, },}}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/NNNZO'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/i1Voices/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
data = {
{
{text = '- قناة السورس', url = 't.me/NNNZO'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/NNNZO'}, 
},
{
{text = 'Annotations Source', url = 'https://t.me/NNNZO'}, 
},
{
{text = 'Communication Source', url = 't.me/KKKZB'}, 
},
{
{text = 'Developer Source !', url = 't.me/KKKZB'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
data = {
{
{text = '[𝟭]', data = msg.sender.user_id..'/help1'}, {text = ' اوامر الادمنيه', data = msg.sender.user_id..'/help2'}, 
},
{
...
if text == (Redis:get(TheBlackPink.."BlackPink:Name:Bot") or "جيزس") then
local NamesBot = (Redis:get(TheBlackPink.."BlackPink:Name:Bot") or "جيزس")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"شكو ؟؟",
"احجي ماليخلك",
"عندي مشاعر؟؟",
"احبك وربي "..NamesBot,
'ولله لو ماجيزس جان شكيت حلكك شنو بوت'
}
return LuaTele.sendText(msg_chat_id,msg_id, NameBots[math.random(#NameBots)],"md",true)  
end
if text == "بوت" then
local NamesBot = (Redis:get(TheBlackPink.."BlackPink:Name:Bot") or "موسكو")
local BotName = {

"همج انت؟ اسمي  "..NamesBot.. "",
"دكلخريان شتريد"
}
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheBlackPink.."BlackPink:Name:Bot") or "موسكو")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/NNNZO'},{text = '᥀ لتنصيب بوت .', url = 't.me/KKKZB'}, 
},
{
...
data = {
{
{text = '[𝟭]', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'}, 
},
{
...
{
{text = '[𝟱]', data = IdUser..'/help5'}, {text = 'الالعاب', data = IdUser..'/help6'}, 
},
{
{text = 'القائمه الرئيسيه ', data = IdUser..'/helpall'},
},
